...
## ⚙️Compiling
```bash
git clone https://github.com/remyone/HexFileViewer.git
cd HexFileViewer/
make main
./main filename
```
...
## License
This project is open source and available under the [MIT License](https://github.com/remyone/HexFileViewer/blob/main/LICENSE)
